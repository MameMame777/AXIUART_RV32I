<#
.SYNOPSIS
    Setup git worktree for Codex development

.DESCRIPTION
    Creates a separate worktree for OpenAI Codex to work independently.
...
.EXAMPLE
    .\scripts\setup_codex_worktree.ps1
    Creates .worktrees/codex with work/codex branch

.EXAMPLE
    .\scripts\setup_codex_worktree.ps1 -Remove
    Removes the codex worktree
#>
